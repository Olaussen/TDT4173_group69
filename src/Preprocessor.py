...
class Preprocessor:
    ...
    def preprocess(self, data):
        ...
        data.drop('phones', 1, inplace=True)
        data.drop('building_id', 1, inplace=True)
        data.drop('stories', 1, inplace=True)
        data.drop('area_living', 1, inplace=True)
        data.drop('new', 1, inplace=True)
        return data
